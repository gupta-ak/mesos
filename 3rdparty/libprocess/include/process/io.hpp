...
/**
 * Prepares a file descriptor to be ready for asynchronous IO. On UNIX systems,
 * this sets the file descriptor to non-blocking. On Windows, this will assign
 * the file descriptor to an IO completion port.
 *
 ...
 *
 * @return Returns if the file descriptor is asynchronous.
